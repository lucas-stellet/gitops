...
class ListWatch {
    ...
    doneHandler() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield this.watch.watch(this.path, { resourceVersion: list.metadata.resourceVersion }, this.watchHandler.bind(this), this.doneHandler.bind(this), this.errorHandler.bind(this));
        });
    }
